...
import { ADD_TO_CART, CALCULATE_TOTAL_QUANTITY, saveCartDB, selectCartItems } from "../../../redux/features/product/cartSlice";


const ProductItem = ({ product, grid, _id, name, price, description, image, regularPrice, ratings}) => {
